...
foreign import stdcall "clCreateSampler" raw_clCreateSampler :: Context -> CLbool -> CLuint -> CLuint -> Ptr CLint -> IO Sampler
...
foreign import stdcall "clRetainSampler" raw_clRetainSampler :: Sampler -> IO CLint
clRetainSampler :: Sampler -> IO () 
clRetainSampler sampler = wrapError $ raw_clRetainSampler sampler

foreign import stdcall "clReleaseSampler" raw_clReleaseSampler :: Sampler -> IO CLint
clReleaseSampler :: Sampler -> IO () 
clReleaseSampler sampler = wrapError $ raw_clReleaseSampler sampler

foreign import stdcall "clGetSamplerInfo" raw_clGetSamplerInfo :: Sampler -> CLuint -> CLsizei -> Ptr () -> Ptr CLsizei -> IO CLint
